...
function renderCommentForm(film) {
 ...
 <input class="form-author" placeholder="Ваше имя" id="author- +film.name">
 <input class="form-comment" placeholder="Ваш отзыв" id="comment- +film.name"> 
   <button onclick="onAddCommentClick('\'+films.name+'\')">Отправить</button></div>`;
