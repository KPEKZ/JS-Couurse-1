...
films[0].AddComments("Крутой фильм!", "Анна", 5);
films[0].AddComments("не очень", "Магомед", 3);
films.push(new Film("Один дома", 0));
films[1].AddComments("он действительно один дома", "пепсикольный", 4);
films[1].AddComments("а теперь не один", "генка", 2);
